...
function showPlayerCards() {
    ...
    if (activeRoom.playerOne.emailAddress) {
        ...
        <div class="media-body truncate"><h3 class="font-bold mb-0">Izq <font class="text-primary">${activeRoom.playerOne.score}</font></h3><h4 class="text-subtitle">${activeRoom.playerOne.emailAddress}</h4></div></div>`;
    }
